...
preloadAssets.forEach(asset => {
  ...
  link.rel = 'preload';
  link.href = asset;
  link.as = asset.endsWith('.js') ? 'script' :  (asset.endsWith('.ttf') ? 'font' : 'fetch');
...
_flutter.loader.load({
  ...
  serviceWorkerSettings: {
    serviceWorkerVersion: "2151012729" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  }
});
